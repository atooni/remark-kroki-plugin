...
class ImageBlock {
    constructor(node, options, imgType, imgAlt, imgTitle, imageCode) {
        this.node = node;
...
const applyCodeBlock = (options, node) => {
    ...
    if (lang === options.lang || isAliasLang) {
        ...
        kb = new ImageBlock(node, options, imgType, imgAlt, imgTitle, value);
    }
    return kb;
};
const transform = (options) => (tree) => new Promise((resolve) => __awaiter(void 0, void 0, void 0, function* () {
    const nodesToChange = [];
